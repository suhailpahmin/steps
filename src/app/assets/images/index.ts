export const Images = {
  ...
  inactiveInsights: require('./icon/inactive-insights.svg'),
  achievement: require('./icon/achievement.svg'),
  inactiveAchievement: require('./icon/inactive-achievement.svg'),
};
